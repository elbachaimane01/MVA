...
from .unet_att import UNetModel_Att
...
def create_model_diffusion_att(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
...
#write create_model_attention using UnetModelATT from unet_att.py 
